                                                                ...
                                                                <div class="modal fade followpopup" id="exampleModal{{$val->_id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form class="assign-team-form" action="{{route($prefix.'.opsPuls.assignTeamOperationManager')}}" method="post" data-parsley-validate>
                                                                                @csrf
                                                                                <div class="row">
                                                                                    <div class="col-xl-12">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        @php 
                                                                                            $teamAssignList = \App\Models\ERP\Team::where('status','1')
                                                                                                                ->where('department',new ObjectId('6790b8b82ef8f2064c61d077')) ///Operation Team
                                                                                                                ->when($branchId, function($query) use($branchId){
                                                                                                                    $query->where('branchId', new ObjectId($branchId));
                                                                                                                })
                                                                                                                ->whereNull('operationManagerId')->get();    
                                                                                        @endphp
                                                                                        
                                                                                        <input type="hidden" name="operationManagerId" value="{{$val->_id}}">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            ...
                                                                            <tbody id="appendBodyData">
                                                                                @php 
                                                                                   $teamList = \App\Models\ERP\Team::where('status','1')->where('operationManagerId', new ObjectId($val->_id))->get();    
                                                                                @endphp
