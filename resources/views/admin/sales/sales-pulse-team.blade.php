                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">View Sales Team</h4>
                        </div>
                        <form>
                        <div class="card-body">
                                                        ...
                                                        <a href="#" style="color: blue" data-bs-toggle="modal"
                                                            ...
                                                            <!-- Modal -->
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form class="assign-team-form" action="{{route($prefix.'.sales.assignTeamSalesManager')}}" method="post" data-parsley-validate>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-xl-12">
                                                                                        <span>{{$val->name}} Emp ID - {{$val->employee_code}}</span>
                                                                                    <div class="mb-3">
                                                                                        <label class="form-label">Team Member</label>
                                                                                        @php 
                                                                                            $teamAssignList = \App\Models\ERP\Team::where('status','1')->where('department',new ObjectId('6790b8962ef8f2064c61d076'))->where('branchId', new ObjectId($val->branchId))->whereNull('createdByTeamId')->get();    
                                                                                        @endphp
                                                                                        ...
                                                                                        <select class="form" name="teamId" required>
                                                                                            ...
                                                                                            @foreach ($teamAssignList as $ta=>$tav)
                                                                                                    <option value="{{$val->_id}}">{{$tav->name}} ({{$tav->employee_code}})</option> 
                                                                                            @endforeach
                                                                ...
                                                                <div class="modal fade followpopup" id="exampleModal2{{$val->_id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">{{$val->name}} Emp ID - {{$val->employee_code}}</h1>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                        <div class="table-responsive">
                                                                            ...
                                                                            <tbody id="appendBodyData">
                                                                                @php 
                                                                                   $teamList = \App\Models\ERP\Team::where('status','1')->where('createdByTeamId', new ObjectId($val->_id))->get();    
                                                                                @endphp
                                                                                @foreach($teamList as $k=>$v)
                                                                                <tr>
                                                                                <td>{{$k+1}}</td>
                                                                                <td style="text-align: left;">
                                                                                    <strong>{{$v->name}} ({{$val->employee_code}})</strong>
                                                                                 </td>
                                                                                </tr>
                                                                                @endforeach
                                                                            </tbody>
