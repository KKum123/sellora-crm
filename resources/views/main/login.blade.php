    ...
    <div class="col-lg-8"> 
        <div class="login-form">
            ...
            @if(\Session::get('success'))
                ...
                @endif
                <form data-parsley-validate action="{{ url('team-login') }}" method="post">
                @csrf
            ...
            @if ($errors->has('email'))
              ...
              @endif
            <input type="password" id="dz-password" name="password" class="input-field" placeholder="Password" required>
...
<script type="">$(".toggle-password").click(function() {
